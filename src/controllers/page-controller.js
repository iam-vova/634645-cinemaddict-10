...
export default class PageController {
  ...
  render(films) {
    ...
    this._showedFilmControllers = this._showedFilmControllers
      .concat(renderFilms(this._filmsRelevant.slice(0, this._showingFilmsCount), this._filmListWrapElement, this._onDataChange, this._onViewChange));
  ...
  _renderLoadMoreButton() {
    ...
    this._loadMoreButtonComponent.setClickHandler(() => {
      ...
      const newFilms = renderFilms(this._filmsRelevant.slice(prevFilmsCount, this._showingFilmsCount), this._filmListWrapElement, this._onDataChange, this._onViewChange);
